        ...
        <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-lg">
                <div class="p-6 sm:p-8">
                    ...
                    <form action="{{ route('checkout.addresses.update', $address->id) }}" method="POST" class="mt-8 space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex items-center justify-end pt-5 mt-4 border-t border-gray-200">
                            <a href="{{ route('checkout.addresses.show') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Cancel
                            </a>
